...
const CarParts = () => {
  ...
  const { handleAddToCart } = useCart(); // Use the handleAddToCart function from CartContext
          ...
          <div key={product.id} className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 p-4">
            <div className="bg-white shadow-md rounded overflow-hidden">
              ...
              <div className="p-4 flex flex-col items-center">
                ...
                <button
                  className="mt-2 bg-transparent border border-orange-500 text-orange-500 hover:bg-orange-500 hover:text-white py-2 px-4 rounded transition duration-300"
